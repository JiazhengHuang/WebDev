...
<?php
// $registUser = '<input type="text" name="registerUsername" placeholder="Username" required>';
// $registUser = htmlspecialchars($registUser);
// echo $registUser;
// echo '<br>';
// $registPS = '<input type="text" name="registerPassword" placeholder="Password" required>';
// $registPS = htmlspecialchars($registPS);
// echo $registPS;
?>
<br><br>
...
if( isset($_SESSION ['registrationError']))
  echo '<span class="Error">' . $_SESSION ['registrationError'] . '</span>'; 
